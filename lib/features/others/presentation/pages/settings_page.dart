...
class _SettingsPageState extends State<SettingsPage> {
                  ...
                  child: Center(
                    child: Container(
                      child: CustomSwitch(
                        ...
                        value: statusGetNewProductNotifications ?? false,
                        onChanged: (value) {
                          print("VALUE : $value");
                ...
                Container(
                  ...
                  child: Center(
                    child: Container(
                      child: CustomSwitch(
                        activeColor: globalColor.primaryColor,
                        value: statusGetNewOfferNotifications ?? false,
                        onChanged: (value) {
                          print("VALUE : $value");
                ...
                Container(
                  ...
                  child: Center(
                    child: Container(
                      child: CustomSwitch(
                        activeColor: globalColor.primaryColor,
                        value: statusGetWalletNotifications ?? false,
                        onChanged: (value) {
                          print("VALUE : $value");
  ...
  _requestSetNotificationsNewProduct(
    ...
    final result = await SetNotificationUseCase(locator<CoreRepository>())(
      SetNotificationParams(
        ...
        notify_wallet: notify_wallet ?? false,
        notify_offer: notify_offer ?? false,
        notify_new_product: notify_new_product ?? false,
      ),
    );
  ...
  _requestSetNotificationsOffer(
    ...
    if (result.hasDataOnly) {
      appSharedPrefs.persistSelectedNotifyOffer(value ?? false);
      if (mounted)
        setState(() {
  ...
  _requestSetNotificationsWallet(
    ...
    if (result.hasDataOnly) {
      appSharedPrefs.persistSelectedNotifyWallet(value ?? false);
      if (mounted)
        setState(() {
