...
class ItemProductCartWidget extends StatefulWidget {
  ...
  const ItemProductCartWidget({required this.item});
...
class _ItemProductHomeWidgetState extends State<ItemProductCartWidget> {
  ...
  late LensesSelectedEnum? _selectedForRightEye;
  late LensesSelectedEnum? _selectedForLeftEye;
  late LensesIpdAddEnum? _selectedForAddIPD;

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    if (!(widget.item.isGlasses ?? true)) {
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      bottom: 4.0,
                                      right: 4.0,
                                      child: widget.item.productEntity?.isNew ??
                                              false
                                          ? Container(
                                              decoration: BoxDecoration(
                                                color: globalColor.primaryColor,
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        ...
                                        child: _buildPriceWidget(
                                          price: widget.item.productEntity
                                                  ?.priceAfterDiscount ??
  ...
  _buildPriceWidget({String? price}) {
    return Container(
      decoration: BoxDecoration(
          color: globalColor.white,
