...
import 'package:ojos_app/core/ui/popup_menu/custom_modal_sheet.dart';
...
class _BasicInfoPageState extends State<BasicInfoPage>
    ...
    return BlocListener<ProfileBloc, ProfileState>(
      ...
      listener: (BuildContext context, state) async {
        if (state is ProfileDoneState) {
          ...
          phoneEditingController.text = state.profile?.mobile ?? '';
  ...
  void _changeImageProfile(String imgUrl, ProfileEntity profile) {
    ...
    //               await Get.Get.toNamed(UpdateProfileImagePage.routeName,arguments:UpdateProfileImagePageArgs(image: image,profile: profile) );
    //               // Get.Get.back();
    //             },
    //             title: Row(
    ...
    //                   pageBuilder: (required BuildContext context,
