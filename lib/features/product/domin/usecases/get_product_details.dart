...
class GetProductDetails extends UseCase<ProductDetailsEntity, GetProductDetailsParams> {
  final ProductRepository repository;

  GetProductDetails(this.repository);

  @override
  Future<Result<BaseError, ProductDetailsEntity>> call(GetProductDetailsParams params) {
