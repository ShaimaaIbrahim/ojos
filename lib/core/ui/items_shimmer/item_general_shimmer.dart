...
class ItemGeneralShimmer extends StatefulWidget {
  ...
  const ItemGeneralShimmer({this.width, this.height, this.isFromHome = false});
...
class _ItemGeneralShimmerState extends State<ItemGeneralShimmer> {
  ...
  late int randomWidth2;
  late int randomWidth3;
  late int randomHeight;
  late int randomHeight2;
  late int randomHeight3;
